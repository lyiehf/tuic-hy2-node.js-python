...
```
curl -Ls https://raw.githubusercontent.com/lyiehf/tuic-hy2-node.js-python/main/hy2.sh | sed 's/\r$//' | bash
```
...
```
curl -Ls https://raw.githubusercontent.com/lyiehf/tuic-hy2-node.js-python/main/tuic.sh | sed 's/\r$//' | bash
```
